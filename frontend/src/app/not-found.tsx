  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center space-y-4">
      <div className="w-14 h-14 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amberAccent shadow-lg">
        <PackageSearch className="w-7 h-7 text-amberAccent" />
      </div>

      <div className="space-y-1 max-w-md">
        <h2 className="text-2xl font-black text-gray-100">404 - Page Not Found</h2>
        <p className="text-xs text-gray-400 leading-relaxed">
          The page or coffee lot trace record you are searching for does not exist or has been relocated.
        </p>
      </div>
